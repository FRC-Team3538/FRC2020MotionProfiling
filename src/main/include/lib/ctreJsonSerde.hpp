...
namespace ctre {
namespace phoenix {
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(CustomParamConfiguration,
                                   customParam0,
                                   customParam1,
                                   enableOptimizations)
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(CANifierConfiguration,
                                   customParam0,
                                   customParam1,
                                   enableOptimizations,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(CANifier::PinValues,
                                   QUAD_IDX,
                                   QUAD_B,
                                   QUAD_A,
                                   LIMR,
...
namespace motion {
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TrajectoryPoint,
                                   position,
                                   velocity,
                                   arbFeedFwd,
                                   auxiliaryPos,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(MotionProfileStatus,
                                   topBufferRem,
                                   topBufferCnt,
                                   btmBufferCnt,
                                   hasUnderrun,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(Faults,
                                   UnderVoltage,
                                   ForwardLimitSwitch,
                                   ReverseLimitSwitch,
                                   ForwardSoftLimit,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(StickyFaults,
                                   UnderVoltage,
                                   ForwardLimitSwitch,
                                   ReverseLimitSwitch,
                                   ForwardSoftLimit,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(StatorCurrentLimitConfiguration,
                                   enable,
                                   currentLimit,
                                   triggerThresholdCurrent,
                                   triggerThresholdTime)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(SupplyCurrentLimitConfiguration,
                                   enable,
                                   currentLimit,
                                   triggerThresholdCurrent,
                                   triggerThresholdTime)
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(FilterConfiguration,
                                   remoteSensorDeviceID,
                                   remoteSensorSource)

NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(SlotConfiguration,
                                   kP,
                                   kI,
                                   kD,
                                   kF,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(BaseMotorControllerConfiguration,
                                   customParam0,
                                   customParam1,
                                   enableOptimizations,
                                   openloopRamp,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(BaseTalonConfiguration,
                                   customParam0,
                                   customParam1,
                                   enableOptimizations,
                                   openloopRamp,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TalonFXPIDSetConfiguration,
                                   selectedFeedbackCoefficient,
                                   selectedFeedbackSensor)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TalonFXConfiguration,
                                   customParam0,
                                   customParam1,
                                   enableOptimizations,
                                   openloopRamp,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TalonSRXPIDSetConfiguration,
                                   selectedFeedbackCoefficient,
                                   selectedFeedbackSensor)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(TalonSRXConfiguration,
                                   customParam0,
                                   customParam1,
                                   enableOptimizations,
                                   openloopRamp,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(VictorSPXPIDSetConfiguration,
                                   selectedFeedbackCoefficient,
                                   selectedFeedbackSensor)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(VictorSPXConfiguration,
                                   customParam0,
                                   customParam1,
                                   enableOptimizations,
                                   openloopRamp,
...
namespace sensors {
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(CANCoderFaults,
                                   HardwareFault,
                                   APIError,
                                   UnderVoltage,
                                   ResetDuringEn,
                                   MagnetTooWeak)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(CANCoderStickyFaults,
                                   HardwareFault,
                                   APIError,
                                   UnderVoltage,
                                   ResetDuringEn,
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(PigeonIMUConfiguration,
                                   customParam0,
                                   customParam1,
                                   enableOptimizations)

NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(PigeonIMU::FusionStatus,
                                   heading,
                                   bIsValid,
                                   bIsFusing,
                                   description,
                                   lastError)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(PigeonIMU::GeneralStatus,
                                   state,
                                   currentMode,
                                   calibrationError,
                                   bCalIsBooting,
                                   ...
                                   lastError)
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(CANCoderConfiguration,
                                   customParam0,
                                   customParam1,
                                   enableOptimizations,
                                   velocityMeasurementPeriod,
